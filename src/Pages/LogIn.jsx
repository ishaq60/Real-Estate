  ...
  return (
    <div className='flex items-center justify-center min-h-screen'>
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl border dark:bg-gray-50 dark:text-gray-800">
        ...
        <p className="text-xs text-center mt-4 text-gray-400 dark:text-gray-600">
          Don't have an account? 
          <NavLink to="/register" className="underline text-violet-600 dark:text-violet-400"> Registration</NavLink>
        </p>
      </div>
    </div>
  );
